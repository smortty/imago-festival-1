...
import { Component, ComponentConstructor, Object as Object3D, Physics, I18N, MorphTargets, Font, GraphicsApi, AudioClip } from './wonderland.js';
...
import { ProbeVolumeScenarioManager } from './resources/volume-scenario-manager.js';
import { ParticleEffectManager } from './resources/particle-effect-manager.js';
import { PipelineManager } from './resources/pipeline-manager.js';
/**
...
export declare class WonderlandEngine {
     ...
     */
    _scene: Scene;
    /** Incremented every time components are registered. @hidden */
    _registrationVersion: number;
    /** Incremented every time a new main scene is loaded. @hidden */
    private _mainSceneVersion;
    /** @hidden */
    private _textures;
    /** @hidden */
    private _materials;
     ...
     * @returns A new loaded {@link PrefabGLTF}.
     */
    loadGLTFFromBuffer(options: InMemoryLoadOptions & GLTFOptions): Promise<PrefabGLTF> | PrefabGLTF;
    /**
    ...
    get particleEffects(): ParticleEffectManager;
    /** Pipeline resources */
    get pipelines(): PipelineManager;
    /** Probe volume scenarios resources */
    get probeVolumeScenarios(): ProbeVolumeScenarioManager;
    /** AudioClip resources */
    get audioClips(): ResourceManager<AudioClip>;
     ...
     * @hidden
     */
    _loadResourcesBin(url: string): Promise<void>;
    /**
    ...
    /**
     * Finish GLTF prefab creation
     *
     * @param index Scene index
     * @returns The GLTF prefab
     *
     * @hidden
     */
    private _createPrefabGLTF;
    /**
    ...
    /**
     * Await a job from the job system.
     *
     * @param targetJobId Job id to wait for.
     * @returns A promise that resolves once the job succeeds or fails.
     */
    private _awaitJob;
}
